...
| MAX_PLAYERS        | Maximum number of players allowed on the server. Vanilla Valheim caps this at 10; any other value automatically installs BepInEx and Azumatt's [MaxPlayerCount](https://thunderstore.io/c/valheim/p/Azumatt/MaxPlayerCount/) mod, which is baked into the image.                    | 10            |
